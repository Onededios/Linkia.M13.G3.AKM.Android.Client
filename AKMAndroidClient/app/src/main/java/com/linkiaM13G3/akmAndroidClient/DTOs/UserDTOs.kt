...
class UserSignUpDTO(var first_name: String, var last_name: String, var email: String, var username: String, var password: String, var telephone: String, var country_code: String)
